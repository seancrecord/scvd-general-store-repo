...
export function prepareHandoff(root,selection,out) {
  ...
  const manifest={schema_version:1,scope:selection.scope,subject:run.subject,run_sha256:hash(runBytes),trace_sha256:run.trace_sha256,
