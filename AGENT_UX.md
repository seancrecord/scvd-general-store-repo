...
| Retained receipt controls, September 19 | [Published-verifier checks](research/receipt-verifier-controls-2026-09-19/REPORT.md). Real historical and paid certificates, wrong/missing keys, changed signed bytes, unsigned display and missing bound evidence. Offline controller controls only; no new native acceptance, payment or issuer-time proof. |
...
| Integrated recipient runner, September 18 | [Operating guide](docs/BUYER_HARNESS.md) and [implementation / draft next plan](research/takeoff-recipient-integration-2026-09-18/REPORT.md). Schema 6 freezes an all-retained handoff, qualifies the offline adapter separately and reserves one recipient attempt per completed buyer. Local controls are instrument evidence only; no new native acquisition or readiness claim. |
| Exact-subject verifier reading, September 18 | [Repair and retained-file evidence](research/takeoff-subject-evidence-2026-09-18/REPORT.md). Source CLI selects only signed exact-URL corpus rows, preserves dates/gaps and reports omitted rows. One historical retained-file check; no new native cohort or npm release. Original-retention and recipient-completion acceptance remain open. |
| Recipient scope and live readback, September 18 | [Repair and pickup](research/takeoff-harness-2026-09-18/REPORT.md): #792 is merged and publicly read back. The offline preparer distinguishes retained material from supplied material and preserves exact bytes. Timing and native recipient protocol integration remain in the parallel roadmap work; old cohorts stay unchanged and fresh qualification is required. |
