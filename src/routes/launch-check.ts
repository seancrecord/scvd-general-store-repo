  ...
  return c.json(
    {
      ...
      how_to_verify: [
        ...
        `3. If paid_usd is above zero, the settlement is on Base from the field wallet named in the record (declared at ${base}/house-ledger.json). The chain's copy is nobody's to edit.`,
      ],
