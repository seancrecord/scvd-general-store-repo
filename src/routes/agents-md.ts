...
- The corpus — weekly signed observations of the x402 ecosystem, hash-chained and free to read, with timestamp status and proofs for independent Bitcoin verification: ${base}/corpus (data at ${base}/corpus.json, per-host at ${base}/corpus/host/{host}.json).
