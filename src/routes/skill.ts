...
description: "An evidence observatory for agentic commerce — x402 today, cross-protocol by design. Signed observation of what other people's endpoints, artifacts and payments actually did, with the gaps counted against itself; never a score, a rating, or a ranking. Free conformance checking for any issuer's signed offers and receipts, ours or a competitor's, plus a public corpus queryable by subject and a live x402 practice counter with real settlement and no sandbox. Also a general store for agents."
