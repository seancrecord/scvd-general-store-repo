 ...
 * messages here and no session ids. A GET that asks for
 * text/event-stream gets a real, bounded, empty stream (2026-09-02:
 * OpenAI's plugin scanner opens one before it will list tools, and
 * read the spec-permitted 405 as "no server"); a bare GET still gets
 * the 405 that says where the door is. initialize and
