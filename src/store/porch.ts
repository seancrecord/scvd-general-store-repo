/**
 * What the night is doing at the Crossing, one line per hour. The porch
...
export const PORCH_AMBIENCE: readonly string[] = [
  ...
  "Post oak smoke from two streets over. The keeper's either cooking or thinking about it, and the difference is thin.",
  ...
  "Somewhere in the pines an owl is doing exactly one call per hour. Rate-limiting itself. Professional.",
  ...
  "Heat lightning over the pines, too far to hear. The sky, arguing properly.",
  ...
  "The smoker's cold tonight. It remembers, though. Cast iron always remembers.",
  "Wind through the pines sounds like traffic that forgave itself.",
