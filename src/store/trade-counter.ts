...
export const TRADE_PARTNERS: readonly TradePartner[] = [
  ...
  },
  {
    ...
    partner_terms: [
      "Both secrets are generated by Hal when the seller creates a listing: the provider key sent in X-Hal-Provider-Key and the HMAC signing secret. The seller saves them; nothing is issued from this side.",
