...
export const DEFECT_CLASSES: readonly DefectClass[] = [
   ...
   */
  {
    ...
    sourced_by:
      "The Machine Payments Protocol's own MUSTs — draft-httpauth-payment-01 and the method drafts in github.com/tempoxyz/mpp-specs, read at main 2026-09-14. Registered 2026-09-03 against draft-httpauth-payment-00; the core draft expired at the IETF Datatracker and was renewed as -01 on 2026-09-09 (mpp-specs#351), a rename whose diff touches the front-matter docname and version and nothing else, so this class keeps the substance it was registered against. This store is the registrar, not the author.",
