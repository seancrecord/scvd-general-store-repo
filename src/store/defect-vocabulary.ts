...
export const DEFECT_CLASSES: readonly DefectClass[] = [
   ...
   */
  {
    ...
    buyer_hint: "Keep the cited check and observation time. Resolve the reported condition before constructing a credential, and independently validate the chosen method and payment terms; this finding comes from an unpaid read, never a payment.",
