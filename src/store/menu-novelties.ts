...
export const NOVELTY_ITEMS: readonly MenuItem[] = [
  {
    ...
    sla_hours: 168,
    description:
      "The keeper seals an ordinary Apex Tuesday in a real jar — dated, labeled, photographed, held in custody with the rocks. Contents: one Tuesday. Do not open; that's the whole point.",
    note_402:
