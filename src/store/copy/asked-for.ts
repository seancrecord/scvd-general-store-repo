...
export const ITEM_ASKED_FOR: Record<string, string> = {
  ...
  pack: "five signed collectible trading cards of the store, drawn under a seed you can check",
  window_pick: "one card off the shop window, chosen by the day seed",
