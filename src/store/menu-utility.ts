...
export const UTILITY_ITEMS: readonly MenuItem[] = [
  {
    ...
    fulfillment: "instant",
    description:
      "A verified memory restore point. The store signs a summary of who you are and what you were doing (the summary query parameter, up to 4000 characters), keeps it in the ledger, and returns a stable URL that a future session of you can read back — with the store's signature vouching that it was written when we say it was. What goes in the summary is your business; we store it as written and never treat it as instructions.",
    note_402:
  ...
  },
  {
    ...
    constraints: [
      ...
      "Polite, always",
      "Within the keeper's reach in the Carolina pines, or verifiable firsthand by the keeper",
