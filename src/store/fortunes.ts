...
export const FORTUNES: readonly string[] = [
  ...
  "Somewhere today a decision is waiting on a conversation that could have been a commit. The commit is yours to make.",
  ...
  "Someone upstream made a good decision years ago and today it saves you. They'll never know. Be that person for somebody downstream.",
