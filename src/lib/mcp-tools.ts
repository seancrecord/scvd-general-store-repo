  ...
  },
  {
    ...
    outputSchema: {
      ...
      properties: {
        ...
        reproduce: { type: "object", description: "The live probe against one signed row: class (same | moved | instrument_moved | not_comparable | no_such_round), both sides, the failed checks added and cleared, and the row's citation." },
