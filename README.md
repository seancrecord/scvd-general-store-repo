...
| **MPP** | [Developer documentation](https://scvd.store/developers) | [MPP scope](https://scvd.store/trust#protocol-mpp): read-only inspection; checkout availability is declared separately in current payment capabilities. No independent MPP directory listing confirmed in this pass. |
