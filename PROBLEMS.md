...
> RECURRENCE, logged 2026-08-19 during the documentation audit: the
> task file (now archived) recorded this same walk stalled again from
> 2026-08-12, past its ~08-14 backlog horizon, AFTER this FIXED stamp.
> The two records disagree and only the keeper's own look settles it;
> logged here so the ledger knows the problem may have come back.
...
(The deep-research transcripts that used to fill the back half of this
file moved to docs/archive/PROBLEMS_RESEARCH_2026-08.md on 2026-08-19.
The problems stay here; the research that informed them is archived.)
