...
describe("the house rules stay citable", () => {
  it("numbers every rule once, and never backwards", () => {
    ...
    // The highest number is the newest rule, and rule 58 is the newest
    // (2026-08-29, the human-facing contract; 57, the five questions
    // an agent arrives with, was adopted in the same evening from the
    // same two sentences of the keeper's).
