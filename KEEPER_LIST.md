...
- **UCP LIVE — distribution started September 19.** Keeper confirmed launch; live profile read back with catalog, checkout and order. [UCP Checker report](https://ucpchecker.com/check/scvd.store) now published with a Verified discovery label and a root signing-key warning to inspect against the actual spec. Paid evidence currently read covers hello/Base; broader advertised scope is not whole-shelf paid qualification. Submitted [community UCP directory #3](https://github.com/homototus/ucp-directory/issues/3), the free UCPList merchant form and [Awesome UCP #30](https://github.com/Upsonic/awesome-ucp/pull/30); all await review. [Receipts and next routes](research/ucp-distribution-2026-09-19/README.md). [Muse intake](research/muse-connector-2026-09-19.md) started, email verification pending; no application or terms acceptance yet. Existing Google merchant-intake status remains separate. Recurring/monthly fees declined.
...
- **Browser origin trials.** September 16 UTC live reading confirms both
  tokens are present: Edge expires 2026-10-15; Chrome expires 2026-11-17.
  Renew the earlier Edge grant before it ends. The door reader already
  derives the soonest expiry from both tokens; this is an advance warning,
  not a current outage. Evidence: `docs/PAYMENT_REACH_QUALIFICATION_2026-09-16.md`.
