...
| Muse | [Connector candidate and intake notes](research/muse-connector-2026-09-19.md); not submitted | UCP is live; intake started September 19 and is waiting on the emailed sign-in code. Fees, connector format and MCP/payment compatibility are not established. Exclude recurring-fee routes. |
