...
| UCP | [Roadmap](ROADMAP.md) | Keeper reports release in testing. Pivot to UCP-specific submissions after live confirmation, with Muse intake in that round. Merchant integration and Google's onboarding remain separate from inspection; no current UCP checkout claim. |
...
| Muse | [Connector candidate and intake notes](research/muse-connector-2026-09-19.md); not submitted | Bundle intake with the UCP distribution round after release. Work-email sign-in gates further requirements. Fees, connector format and MCP/payment compatibility are not established. Exclude recurring-fee routes. |
