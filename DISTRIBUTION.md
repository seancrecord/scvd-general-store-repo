...
| MPP | [Developers](https://scvd.store/developers) | Context Anchor MPP is live: September 17 unsigned GET advertised EVM charge / Base / 1 USDC alongside x402. Menu and OpenAPI capability declarations agree; other products are upcoming. Curated MPP and MPPScan intake still need discovery qualification; see [coverage](research/distribution-2026-09-17/PROTOCOL_COVERAGE.md). |
