...
- [ ] Founding edition — keeper's edited pass APPLIED 2026-07-24 (Issue No. 1 masthead/tenure clock, THE BOOKS honest-zero section, partnership WHO RUNS IT, Claudius Maximus counter note, checkable cat claim). THREE HOLDS gate the wire-up, keeper to resolve: (1) Oak City vs Smokewire Crossing — his pass used stale canon; Oak City held, explicit re-rule flips it storewide; (2) "signed and archived forever" — build edition signing (recommended, on-thesis) or soften the masthead; (3) clawdbot bell attribution — softened to "somebody," overrule prints it as a flagged guess. ALSO: THE BOOKS numbers go stale when the shopping run executes — publish first or re-check at publish. On resolution: wire /gazette/founding free page + sitemap + rack link. The letter stays standalone at registry/launch-post-draft.md for external venues. Test Bench (his mention, unknown to this repo) held for Issue No. 2 per his own note
