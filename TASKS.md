...
- [ ] Founding edition — MERGED with the launch post 2026-07-24 per keeper direction: the letter leads verbatim ("A LETTER FROM THE KEEPER"), WHO RUNS IT rewritten to the partnership (shopkeeper Sean = the keeper, shoptender Claude at the counter), duplicates removed, /stats added, "coffee in hand" fixed. AWAITING KILL-PASS at registry/founding-edition-draft.md; on the nod it wires as the FREE page at /gazette/founding + sitemap + rack link. The letter text stays available standalone for Moltbook/his channels
