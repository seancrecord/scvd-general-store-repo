...
const scenario = process.argv[2] ?? 'unsupported';
if (scenario !== 'unsupported') throw new Error(`Expected unsupported scenario, got ${scenario}`);
...
writeFileSync('observed.json', `${JSON.stringify(output, null, 2)}\n`);
