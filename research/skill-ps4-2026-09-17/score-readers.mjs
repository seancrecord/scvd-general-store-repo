...
const result={date:'2026-09-17',scope:protocol.scope,rows,newSkillPassed:rows.filter(r=>r.variant==='new').length===2&&rows.filter(r=>r.variant==='new').every(r=>r.passed)};
