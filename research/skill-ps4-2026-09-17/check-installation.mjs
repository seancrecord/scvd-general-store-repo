...
fs.writeFileSync('research/skill-ps4-2026-09-17/installation-final.txt',result.stdout+result.stderr);
...
fs.writeFileSync('research/skill-ps4-2026-09-17/installation-final.json',JSON.stringify({cliVersion:'1.5.26',cwd,args,exitCode:result.status,canonicalSha256,installations,scope:'Local source, project installation, copy mode. No remote marketplace installation claim.'},null,2)+'\n');console.log('Both installed skill trees match the current canonical source.');
