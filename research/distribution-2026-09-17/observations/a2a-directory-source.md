...
| [Kinocut](https://kinocut.dev) | [@KyaniteLabs](https://github.com/KyaniteLabs) | Open-source guardrailed FFmpeg video-editing agent for AI pipelines (196 MCP tools; Python/CLI; 114★). Public read-only guide agent answers installation, workflow, and safeguard questions over JSON-RPC at /a2a/v1 — it cannot edit media, access files, or run commands; editing happens locally via the MCP server. [Agent Card](https://kinocut.dev/.well-known/agent-card.json) \| [llms.txt](https://kinocut.dev/llms.txt) | [![Stars](https://img.shields.io/github/stars/KyaniteLabs/kinocut?style=social)](https://github.com/KyaniteLabs/kinocut) |
...
| [a2a-to-mcp](https://github.com/AmirK-S/a2a-to-mcp) | [@AmirK-S](https://github.com/AmirK-S) | Bridge that exposes A2A v1.0.1 agents as tools on a stateless MCP 2026-07-28 server, with the `io.modelcontextprotocol/tasks` extension for long-running tasks and a legacy 2025-11-25 route on the same endpoint. Four tools, discover, send message, get task and cancel task, each taking the agent alias as an argument, with typed A2A errors and task states mapped explicitly. Node 20+, published on npm as `a2a-to-mcp`. Apache 2.0. | [![Stars](https://img.shields.io/github/stars/AmirK-S/a2a-to-mcp?style=social)](https://github.com/AmirK-S/a2a-to-mcp) |
[⬆️ Back to Contents](#contents)
