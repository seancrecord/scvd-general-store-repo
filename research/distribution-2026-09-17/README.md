...
[FOLLOWUPS.md](FOLLOWUPS.md). Only the 8004scan report has been sent; the other
...
| ERC-8004 | trust8004 field normalization; AgentERC ingestion | Drafts ready; support routes unresolved | [Follow-ups](FOLLOWUPS.md) |
