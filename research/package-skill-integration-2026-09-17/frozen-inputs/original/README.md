...
against the supplied key. It does not establish real service authorization,
delivery, settlement, merchant trust, or permission to spend. For your own
artifacts, establish the signing key and its authorization independently;
a key included beside an untrusted artifact is not evidence of authority.
