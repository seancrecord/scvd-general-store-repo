 ...
 * 
 * UA: scvd-walkabout/1.0 (+https://scvd.store/what) x402-field-research
 * Every outbound request carries this string. No exceptions.
 */
...
const UA = "scvd-walkabout/1.0 (+https://scvd.store/what) x402-field-research";
...
async function attemptPurchase(url, method = "GET", body = null) {
  ...
  try {
    ...
    if (entry.paid) {
      ...
      entry.body_preview = responseBody.substring(0, 200);
