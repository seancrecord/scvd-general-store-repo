...
[IMAGE 1: the featured image. The four buckets, with the 6.5% slice
labelled "what I blamed."]
...
[IMAGE 2: the x402 challenge as a form. Fields: scheme, network, asset,
amount, payTo, timeout, resource. One empty dotted-outline slot labelled
"required inputs: (no field)".]
...
[IMAGE 3: horizontal bar chart of the seven rows. 400 dominates.]
