...
- **M2 [~] — subject dimensions in the corpus schema.** Envelope
  ...
  freshness_coherence, receipt_coherence (dogfood field first),
  registry_coherence, corrections, stated_conditions.
  identity_binding remains ⚑ G2. Corpus schema still open
  (G-schema).
